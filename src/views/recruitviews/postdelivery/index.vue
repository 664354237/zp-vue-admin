        ...
        <div class="home-content">
            <table-content :AllTitle='AllTitle' :tableData='tableData' :table='table'>
                ...
                <template slot="status" slot-scope="{row}">
                    <el-button icon="el-icon-user" class="btnblue" size="mini" type="primary" @click="handleDiagram(row)">查看更多</el-button>
                </template>
            </table-content>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        handleDiagram(){
            this.$router.push('/recruitviews/postdelivery/0')
        }
    },
    components:{
        RecruitviewsHeader,
